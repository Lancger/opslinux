...
export VER=3.5.6
cd /usr/local/src/
wget https://archive.apache.org/dist/zookeeper/zookeeper-${VER}/apache-zookeeper-${VER}-bin.tar.gz
```
...
cd /usr/local/src/
tar zxvf apache-zookeeper-${VER}-bin.tar.gz
mv apache-zookeeper-${VER}-bin/ /usr/local/zookeeper
